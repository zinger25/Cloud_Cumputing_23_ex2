...
scp -i $KEY_PEM -o "StrictHostKeyChecking=no" -o "ConnectionAttempts=60" endpoints.json ubuntu@$PUBLIC_IP:/home/ubuntu/
...
ssh -i $KEY_PEM -o "StrictHostKeyChecking=no" -o "ConnectionAttempts=10" ubuntu@$PUBLIC_IP<<EOF
    ...
    tmux new-session -d -s my-session 'go run worker_app.go'
